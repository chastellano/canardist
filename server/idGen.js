const words = {
    first: [ 'community', 'randy', 'frothing', 'slippery', 'inverted', 'burly', 'serene', 'tidy', 'disco', 'digital' ],
    second: [ 'badger', 'bathtub', 'bucket', 'pulpit', 'scone', 'genius', 'witness', 'blanket', 'trumpet', 'toddler' ]
}
